...
$(function() {
  var $cartTotal, packagePrice, selectedPackageElement, setCartItemCount, updateCartTotal, updatePackageSubmitButton, updatePackageTotal;
  ...
  selectedPackageElement = function() {
    return $('[data-package]:checked');
  };
  ...
  updatePackageSubmitButton = function() {
    var $button, href, originalHref, params;
    ...
    params = $.param({
      package_good_global_id: selectedPackageElement().val()
    });
  ...
  $('[data-package]').on('change', function() {
    updatePackageTotal();
    updateCartTotal();
    return updatePackageSubmitButton();
  });
...
},{}],"fancybox.wannabe":[function(require,module,exports){
 /*!
...
},{}],"fancybox":[function(require,module,exports){
/*!
...
},{}],"jquery.role":[function(require,module,exports){
!function($){
